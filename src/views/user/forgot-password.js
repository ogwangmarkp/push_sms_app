    ...
    <Row className="h-100">
      <Colxx xxs="12" md="10" className="mx-auto my-auto">
        <Card className="auth-card">
          <div className="position-relative image-side login-left">
            <p className="h2">Welcome to</p>
            <p className="h1 w-700">QB Core</p>
            <p className="mb-0 s-15">
              Please use your username to reset your password. <br />
          ...
          <div className="form-side card">
            <div className='logo-login'>
              <img alt='System Logo' src='/assets/logos/logo-sm.png' />
            </div>
              ...
              {({ errors, touched }) => (
                <Form className="av-tooltip tooltip-label-bottom">
                  ...
                  <div className="d-flex justify-content-between align-items-center">
                    <NavLink className='m-10' to="/user/login">
                  ...
                  <div className="d-flex justify-content-end align-items-end">
                    <Button
                      color="primary"
                      className={`btn-shadow btn-login btn-multiple-state ${loading ? 'show-spinner' : ''
                        }`}
                      size="lg"
                    >
